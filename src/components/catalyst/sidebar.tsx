...
export function SidebarHeading({ className, ...props }: React.ComponentPropsWithoutRef<'h3'>) {
 return (
 <h3 {...props} className={clsx(className, 'mb-1 px-2 text-xs leading-6 font-medium text-zinc-500 dark:text-zinc-400')} />
 )
}
...
export const SidebarItem = forwardRef(function SidebarItem(
 ...
 let classes = clsx(
 // Base
 'flex w-full items-center gap-3 rounded-lg px-2 py-2.5 text-left text-base leading-6 font-medium text-zinc-950 sm:py-2 sm:text-sm sm:leading-5',
