...
const styles = {
 base: [
 // Base
 'relative isolate inline-flex items-baseline justify-center gap-x-2 rounded-lg border text-base leading-6 font-semibold',
 // Sizing
 'px-[calc(0.875rem-1px)] py-[calc(0.625rem-1px)] sm:px-[calc(0.75rem-1px)] sm:py-[calc(0.375rem-1px)] sm:text-sm sm:leading-6',
 // Focus
 'focus:[&:not([data-focus])]:outline-none data-[focus]:outline-2 data-[focus]:outline-offset-2 data-[focus]:outline-blue-500',
 // Disabled
 ...
 'before:absolute before:inset-0 before:-z-10 before:rounded-[calc(0.5rem-1px)] before:bg-[var(--btn-bg)]',
 ...
 outline: [
 // Base
 'border-zinc-950/10 text-zinc-950 data-[active]:bg-zinc-950/[0.025] data-[hover]:bg-zinc-950/[0.025]',
 // Dark mode
 ...
 light: [
 'text-zinc-950 [--btn-bg:white] [--btn-border:var(--color-zinc-950)]/10 [--btn-hover-overlay:var(--color-zinc-950)]/[0.025] data-[active]:[--btn-border:var(--color-zinc-950)]/15 data-[hover]:[--btn-border:var(--color-zinc-950)]/15',
