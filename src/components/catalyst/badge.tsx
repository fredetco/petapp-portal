...
export function Badge({ color = 'zinc', className, ...props }: BadgeProps & React.ComponentPropsWithoutRef<'span'>) {
 ...
 className={clsx(
 className,
 'inline-flex items-center gap-x-1.5 rounded-md px-1.5 py-0.5 text-sm leading-5 font-medium sm:text-xs sm:leading-5 forced-colors:outline',
 colors[color]
 )}
 />
 )
...
export const BadgeButton = forwardRef(function BadgeButton(
 ...
 let classes = clsx(
 className,
 'group relative inline-flex rounded-md focus:[&:not([data-focus])]:outline-none data-[focus]:outline-2 data-[focus]:outline-offset-2 data-[focus]:outline-blue-500'
 )
