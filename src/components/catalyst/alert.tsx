...
export function AlertTitle({
 ...
 className={clsx(
 className,
 'text-center text-base leading-6 font-semibold [text-wrap:balance] text-zinc-950 sm:text-left sm:text-sm sm:leading-6 sm:text-wrap dark:text-white'
 )}
 />
 )
}
...
export function AlertDescription({
 ...
 as={Text}
 {...props}
 className={clsx(className, 'mt-2 text-center [text-wrap:pretty] sm:text-left')}
 />
 )
}
