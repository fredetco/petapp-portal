...
export function DropdownItem({
 ...
 // Text styles
 'text-left text-base leading-6 text-zinc-950 sm:text-sm sm:leading-6 dark:text-white forced-colors:text-[CanvasText]',
 // Focus
...
export function DropdownHeading({
 ...
 className={clsx(
 className,
 'col-span-full grid grid-cols-[1fr_auto] gap-x-12 px-3.5 pt-2 pb-1 text-sm leading-5 font-medium text-zinc-500 sm:px-3 sm:text-xs sm:leading-5 dark:text-zinc-400'
 )}
 />
 )
}
...
export function DropdownDescription({
 ...
 className={clsx(
 className,
 'col-span-2 col-start-2 row-start-2 text-sm leading-5 text-zinc-500 group-data-[focus]:text-white sm:text-xs sm:leading-5 dark:text-zinc-400 forced-colors:group-data-[focus]:text-[HighlightText]'
 )}
 />
 )
}
