...
export const Select = forwardRef(function Select(
 ...
 // Typography
 'text-base leading-6 text-zinc-950 placeholder:text-zinc-500 sm:text-sm sm:leading-6 dark:text-white dark:*:text-white',
 // Border
 ...
 // Disabled state
 'data-[disabled]:border-zinc-950/20 data-[disabled]:opacity-100 dark:data-[disabled]:border-white/15 dark:data-[disabled]:bg-white/[0.025] dark:data-[hover]:data-[disabled]:border-white/15',
 ])}
 />
 {!multiple && (
